...
@section('admin_content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-10 m-auto col-lg-10 m-auto">
                    ...
                    <div class="col-sm-4">
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Growth">Visit shop</h5>
                                <a href="/store/{{ auth()->user()->id }}" class="btn btn-primary p-2">Visit</a>
                                {{-- <p class="mb-0 text-muted">
                                    <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>
                                        4.87%</span>
                                    <span class="text-nowrap">Since last month</span>
