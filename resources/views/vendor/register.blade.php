...
<head>
    ...
    <!-- App css -->
    <link href="{{asset("assets_admin/css/app-saas.min.css")}}" rel="stylesheet" type="text/css" id="app-style" />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center pb-0 fw-bold">Vendor Sign Up</h4>
                                {{-- <p class="text-muted mb-4">Enter your email address and password to access admin panel. --}}
                                </p>
                            </div>

                            <form action="{{route("vendor._register")}}" method="POST">
                                @csrf
                                <div class="mb-3">
