            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <a href="{{ route('sub_categories.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle me-2"></i> Add Sub Categories</a>
                            </div>
                            {{-- <div class="col-sm-7">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                ...
                                <tbody>
                                    @foreach ($sub_categories as $i => $blog)
                                        <tr>
                                            <th>
                                                {{ $i + 1 }}
                                            </th>
                                            ...
                                            <a href="javascript:void(0);" class="action-icon"> <i
                                                ...
                                                <form action="{{ route('sub_categories.destroy', $blog->id) }}" method="POST"
