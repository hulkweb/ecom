                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <form action="{{ route('categories.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="projectname" class="form-label">Category Image</label>
                                        <input type="file" id="projectname" class="form-control"
                                            placeholder="Enter category name" name="image">
                                    </div>
                                    <div class="mb-3">
