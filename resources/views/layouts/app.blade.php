                    ...
                    <ul class="horizontal-menu">
                        ...
                        @if (auth()->user())
                            ...
                            <li>
                                ...
                                <a href="{{ route('dashboard') }}" class="login-link"><i
                                        class="biolife-icon icon-login"></i>{{ auth()->user()->name }}</a>
                            </li>
                            <li class="horz-menu-item lang">
                                <a href="/logout" class="login-link"><i
                                        class="biolife-icon icon-sign-out"></i>logout</a>
                        ...
                        @else
                          <li>  <a href="{{route("login")}}" class="login-link"><i
                            ...
                            <li>
                                ...
                                <a href="{{ route('vendor.login') }}" class="login-link"><i
                    ...
                    <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu"
                                ...
                                @if (auth()->user())
                                    <li class="menu-item"><a href="/dashboard">My Account</a></li>
                                @else
                        ...
                        <div class="biolife-cart-info">
                            <div class="mobile-search">
                                ...
                                <div class="mobile-search-content">
                                    <form action="/filter" class="form-search" name="mobile-seacrh" method="get">
                                        @csrf
                ...
                <div class="row">
                                ...
                                <ul class="menu clone-main-menu">
                                    @foreach (get_categories() as $item)
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="/filter?category={{ str_replace(' ', '-', $item->title) }}"
                                                class="menu-name text-capitalize" data-title="Fruit & Nut Gifts">
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        <div class="header-search-bar layout-01">
                            <form action="/filter" class="form-search" name="desktop-seacrh" method="get">
                                <input type="text" name="keyword" class="input-text" value=""
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b
                                    class="phone-number">{{ settings()['mobile_of_footer'] }}</b></p>
    ...
    <div class="mobile-footer">
        <div class="mobile-footer-inner">
            ...
            <div class="mobile-block block-global">
                ...
                @else
                    <a class="menu-bar myaccount-toggle btn-toggle" data-object="global-panel-opened" href="/login">
                        <span class="fa fa-user"></span>
        ...
        <div class="block-global-contain">
            <div class="glb-item my-account">
                ...
                <ul class="list">
                    ...
                    <li class="list-item"><a href="/cart">Cart <span
                                class="index">({{ count(get_cart()) }})</span></a></li>
            ...
            <div class="glb-item currency">
                ...
                <ul class="list">
                    ...
                    <li class="list-item"><a href="#">₹ INR (Rupees)</a></li>
