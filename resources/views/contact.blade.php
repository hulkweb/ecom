                ...
                <div class="row">
                            ...
                            <ul class="addr-info">
                                <li>
                                    <div class="if-item">
                                        ...
                                        <p class="dsc">{{ settings()['address_of_footer'] }}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Phone:</b>
                                        <p class="dsc">{{ settings()['mobile_of_footer'] }}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Email:</b>
                                        <p class="dsc">{{ settings()['email_of_footer'] }}</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Store Open:</b>
                                        <p class="dsc">{{ settings()['hours_of_footer'] }}</p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="contact-form-container sm-margin-top-112px">
                            <form action="{{route("queries.store")}}" method="POST" name="frm-contact" >
                                @csrf
                                <p class="form-row">
